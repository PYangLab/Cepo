...
You can install the development version of _Cepo_ from GitHub using the `remotes`
package:
...
The documentation for _Cepo_ is available from <https://pyanglab.github.io/Cepo/>.
...
> stability with Cepo. _Nature Computational Science_ 1, 784-790 (2021).
...
To find all source code related to the analyses of the paper, please refer to
<https://github.com/PYangLab/CepoManuscript>.
