...
We can now perform a plethora of downstream analyses, from gene set enrichment analyses to deconvolution of bulk RNA-seq, with the selected cell identity genes. As an example, we will perform gene set enrichment analysis using the `fgsea` and  `escape` package.
```{r}
library(escape)
library(fgsea)
